...
/* Prototype for ISR of TIMER0 Normal Mode */
...
/* Prototype for ISR of TIMER0 CTC Mode */
void __vector_10 (void) __attribute__((signal));
void __vector_10 (void)
{
	static u16 Local_u16CounterCTC = 0;
	Local_u16CounterCTC++;				// setting the counter to count up.
	if(Local_u16CounterCTC == 10)   	// till it become 1 ms. (10 cicles for 16MHz CPU frequency)
	{
		/* Clear Counter */
